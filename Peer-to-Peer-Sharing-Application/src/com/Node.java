 ...
 * list of message handlers, and a handler for routing data through the P2P
 * network.
 * 
 * 
 *
...
public class Node {
	...
	/*
	 * This class is used to respond to and handle incoming connections in a
	 * separate thread.
	 */
	...
	/*
	 * This class is used to set up "stabilizer" functions to run at specified
	 * intervals
	 */
	...
	/**
	 * Initialize this node with the given info and the specified limit on the
	 * size of the peer list.
	 * 
	 * @param maxPeers
	 *            the maximum size of the peer list (0 means 'no limit')
	 * @param info
	 *            the id and host/port information for this node
	 */
	...
	/**
	 * Initialize this node with no limit on the size of the peer list and set
	 * up to listen for incoming connections on the specified port.
	 */
	...
	/*
	 * Attempt to determine the name or IP address of the machine this node is
	 * running on.
	 */
	...
	/**
	 * Attempts to route and send a message to the specified peer, optionally
	 * waiting and returning any replies. This method using the Node's routing
	 * function to decide the next immediate peer to actually send the message
	 * to, based on the peer identifier of the final destination. If no router
	 * function (object) has been registered, it will not work.
	 * 
	 * @param peerid
	 *            the destination peer identifier
	 * @param msgtype
	 *            the type of the message being send
	 * @param msgdata
	 *            the message data
	 * @param waitreply
	...
	/**
	 * Starts the loop which is the primary operation of the Node. The main loop
	 * opens a server socket, listens for incoming connections, and dispatches
	 * them to registered handlers appropriately.
	 */
	 ...
	 * 
	 * @param st
	 *            the stabilizer function object
	 * @param delay
	 ...
	 * 
	 * @param key
	 *            the key associated with the peer
	 * @param pd
	 *            the peer information
	 * @return true if successful; false if maxPeers is reached, or if the peer
	 *         list already contains the given key.
	 */
